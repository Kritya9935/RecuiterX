...
const schema = yup
  .object()
  .shape({
    name: yup.string().required().min(2).max(4),
 ...
 function RecruiterRegister(){
    ...
    const { register, handleSubmit, formState: { errors } } = useForm({
      ...
      const handleData=async(data)=>{
        ...
        const res= await   axios.post("http://localhost:9000/api/recruiter-register",formData,{
            headers:{
        ...
        <div className="col-sm-10">
            <div className="row">
                ...
                <div className="col-sm-6 form_div_register ">
                    <h2 className="recruiter_signUp_text">Recruiter SingUp</h2>
                <div className="p-4">
